...
public class CadastrarMarca extends HttpServlet {
	...
	protected void doPost(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
		...
		if("cadastrar".equals(operacao)) {
			...
			String especializacao = req.getParameter("especializacao");
			
			Marca marca = new Marca();
			marca.setCodigo(codigo);
			marca.setNome(nome);
			marca.setDescricao(descricao);
			marca.setEspecializacao(especializacao);
		...
		resp.sendRedirect("cadastrarMarca?operacao=Pesquisar");
	}
	...
	private String prepararPaginaCadastro() {
		...
		html.append(gerarCabecalhoHTML("Cadastrar Marca"));
		html.append("  <div class='container'>");
		html.append("      <fieldset>");
		html.append("          <legend>Cadastrar Nova Marca</legend>");
		html.append("          <form action='cadastrarMarca' method='post'>");
		...
		html.append("              <input type='text' id='descricao' name='descricao' required><br>");
		
		html.append("              <label for='especializacao'>Especialização:</label>");
		html.append("              <input type='text' id='especializacao' name='especializacao' required><br>");
		
		html.append("              <input type='submit' value='Cadastrar'>");
		html.append("          </form>");
		html.append("      </fieldset>");
		html.append("      <div class='actions-container'>");
		html.append("          <a href='cadastrarMarca?operacao=Pesquisar' class='link-primary'>&#8592; Voltar para a lista de marcas</a>");
	...
	private String prepararPaginaConsulta() {
		List<Marca> marcaList = new MarcaDao().consultar();
		StringBuilder html = new StringBuilder();
		html.append(gerarCabecalhoHTML("Consultar Marcas"));
		html.append("  <div class='container'>");
		html.append("      <fieldset>");
		html.append("          <legend>Marcas Cadastradas</legend>");
		html.append("          <table>");
		html.append("              <tr><th>Código</th><th>Nome</th><th>Descrição</th><th>Especialização</th><th>Ação</th></tr>");
		
		for (Marca m : marcaList) {
			html.append("              <tr>");
			html.append("                  <td>").append(m.getCodigo()).append("</td>");
			html.append("                  <td>").append(m.getNome()).append("</td>");
			html.append("                  <td>").append(m.getDescricao()).append("</td>");
			html.append("                  <td>").append(m.getEspecializacao()).append("</td>");
			html.append("                  <td>");
			html.append("                      <form action='cadastrarMarca' method='post' style='margin:0;'>");
		...
		html.append("      </fieldset>");
		html.append("      <div class='actions-container'>");
		html.append("          <a href='cadastrarMarca' class='link-primary'>&#43; Cadastrar Nova Marca</a>");
		html.append("          <a href='/femaservlet/inicial.html' class='btn-voltar'>Voltar ao Menu Principal</a>");
		html.append("      </div>");
		html.append("  </div>");
		html.append("</body></html>");
